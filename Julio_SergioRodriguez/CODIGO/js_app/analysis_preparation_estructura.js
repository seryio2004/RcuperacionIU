const estructura_analysis_preparation = {
    ...
    attributes: {
        id_analysis_preparation: {
            ...
            validation_rules: {
                ADD: {
                    min_size: [1, 'id_analysis_preparation_min_size_KO'],
                    max_size: [11, 'id_analysis_preparation_max_size_KO'],
                    format: ['^\\d{1,11}$', 'id_analysis_preparation_format_KO']
                },
                SEARCH: {
                    max_size: [11, 'id_analysis_preparation_max_size_KO'],
                    format: ['^\\d{1,11}$', 'id_analysis_preparation_format_KO']
        ...
        bib_analysis_preparation: {
            ...
            validation_rules: {
                ADD: {
                    ...
                    format: ['^[A-Za-zÁÉÍÓÚáéíóúÑñ .,;:!?¿¡\"\-()]+$', 'bib_analysis_preparation_format_KO']
                },
                EDIT: {
                    min_size: [6, 'bib_analysis_preparation_min_size_KO'],
                    max_size: [200, 'bib_analysis_preparation_max_size_KO'],
        ...
        file_analysis_preparation: {
            ...
            validation_rules: {
                ADD: {
                    ...
                    file_type: [
                        'application/pdf',
                        'file_analysis_preparation_file_type_KO'
                    ],
